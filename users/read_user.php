    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">bibliothécaire</span>
            </a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <p class="form-control-static"><?php echo $nom_user; ?></p>
                            </div>
                            <div class="form-group">
                                <label class="fw-bold">Prénom</label>
                                <p class="form-control-static"><?php echo $prenom_user; ?></p>
                            </div>

                            <div class="form-group">
                                <label class="fw-bold">Nom d'utilisateur</label>
                                <p class="form-control-static"><?php echo $username_user; ?></p>
                            </div>

                            <div class="form-group">
                                <label class="fw-bold">Mot de passe</label>
                                <p class="form-control-static"><?php echo $password_user; ?></p>
                            </div>

                            <div class="form-group">
                                <label class="fw-bold">Adresse</label>
                                <p class="form-control-static"><?php echo $adresse_user; ?></p>
                            </div>
