    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">bibliothécaire</h5>
              <a href="create_user.php" class="btn btn-success pull-right">Ajouter</a>
              ...
              if ($result = $link->query($sql)) {
                ...
                if ($result->fetchColumn() > 0) {
                  ...
                  foreach ($link->query($sql) as $row) {
                    ...
                    echo "<a href='update_user.php?id=" . $row['ID_USER'] . "' title='Update Record' data-toggle='tooltip'> <i class='bi bi-pen-fill'></i></a>";
                    echo "<a href='delete_user.php?id=" . $row['ID_USER'] . "' title='Delete Record' data-toggle='tooltip'><i class='bi bi-trash-fill'></a>";
                    echo "</td>";
                    echo "</tr>";
                  }
                  echo "</tbody>";
